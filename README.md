...
### 1️⃣ Выберите версию промпта

У нас есть три версии:

| Версия | Размер | Когда использовать | Файл |
|--------|--------|-------------------|------|
| **Full** | ~30KB | Профессиональная разработка | [prompts/system_prompt_full.md](./prompts/system_prompt_full.md) |
| **Mini** | ~20KB | Бесплатные планы, простые задачи | [prompts/system_prompt_mini.md](./prompts/system_prompt_mini.md) |
| **Universal** | ~3KB | Для других областей (не только код) | [prompts/system_prompt_universal.md](./prompts/system_prompt_universal.md) |

### 2️⃣ Установите промпт для вашей платформы

Выберите платформу и следуйте инструкции:

*   **Claude:** [templates/claude/full.md](./templates/claude/full.md)
*   **ChatGPT:** [templates/chatgpt/custom_instructions.md](./templates/chatgpt/custom_instructions.md)
*   **Open WebUI (локальные LLM):** [templates/local-llm/openwebui.md](./templates/local-llm/openwebui.md)
*   **VS Code (Continue):** [templates/vscode/README.md](./templates/vscode/README.md)

Подробное руководство: [docs/INTEGRATION_GUIDE.md](./docs/INTEGRATION_GUIDE.md)

### 3️⃣ Настройка под ваш проект

Отредактируйте секцию `Контекст Проекта` в выбранном промпте:
...
Если промпт установлен правильно, вы увидите таблицу всех доступных команд.
...
```
/tz для системы авторизации
```

AI проанализирует требования, задаст уточняющие вопросы и сформирует техническое задание.

**Больше примеров:**
- [Laravel проект](./examples/laravel/README.md)
- [EXAMPLES.md](./EXAMPLES.md) - все примеры команд
...
│   ├── system_prompt_full.md       # Полная версия
│   ├── system_prompt_mini.md       # Облегченная версия
│   └── system_prompt_universal.md  # Универсальный шаблон
├── templates/            # Шаблоны для интеграции
│   ├── claude/          # Инструкции для Claude
│   ├── chatgpt/         # Инструкции для ChatGPT
│   ├── local-llm/       # Локальные модели (Ollama, Open WebUI)
│   └── vscode/          # Интеграция с VS Code (Continue)
├── examples/             # Примеры использования
│   ├── laravel/         # Примеры для Laravel
│   ├── nodejs/          # Примеры для Node.js (TODO)
│   └── python/          # Примеры для Python (TODO)
├── docs/                 # Документация
...
- **[Руководство по интеграции](./docs/INTEGRATION_GUIDE.md)** - Подробное руководство по встраиванию в ваши проекты
- **[Примеры для Laravel](./examples/laravel/README.md)** - Реальные кейсы использования
- **[Примеры команд](./EXAMPLES.md)** - Все команды с примерами
- **[История изменений](./CHANGELOG.md)** - Что нового в каждой версии

### Шаблоны интеграции

- [Claude](./templates/claude/) - Инструкции для Claude (Anthropic)
- [ChatGPT](./templates/chatgpt/) - Инструкции для ChatGPT (OpenAI)
- [Локальные LLM](./templates/local-llm/) - Open WebUI, Ollama и др.
- [VS Code](./templates/vscode/) - Интеграция через Continue
...
**Особенно нужны:**
- Примеры для других стеков (Node.js, Python, Go, Ruby и др.)
- Переводы документации
- Новые интеграции с IDE
